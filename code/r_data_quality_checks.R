...
# Run the install.packages() lines if you haven't installed these packages yet
...
# install.packages("openxlsx")
  ...
  # NOTE —— A quicker, alternative way to run the above is the following:

#   if(!require(pacman)) install.packages("pacman")
#   pacman::p_load(here, tidyverse, tidyselect, janitor, openxlsx)
...
# One exception
  ...
  openxlsx::saveWorkbook(
      hfc_excel, here("output", "hfc_output.xlsx"), overwrite = TRUE
  )
